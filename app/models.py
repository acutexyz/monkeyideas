...
class Monkey(db.Model):
    ...
    requests = db.relationship('JoinRequest', backref='monkey', lazy='dynamic')
    suggestions = db.relationship('Suggestion', backref='monkey', lazy='dynamic')
...
class Idea(db.Model):
    ...
    suggestions = db.relationship('Suggestion', backref='idea', lazy='dynamic')
...
class JoinRequest(db.Model):
    ...
    def __init__(self, monkey_id, idea_id, message=""):
