...
@login_required
def home():
    return render_template("monkeys/home.html")
...
def list_monkeys(page=1):
    ...
    return render_template("monkeys/monkeys.html", pagination=pagination)
...
def show_monkey(id):
    ...
    if monkey is None:
        abort(404)
    return render_template("monkeys/monkey.html", monkey=monkey)
